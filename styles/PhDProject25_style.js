...
var styleCache_PhDProject25={}
var style_PhDProject25 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (!styleCache_PhDProject25[key]){
        ...
        styleCache_PhDProject25[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_PhDProject25[key]];
