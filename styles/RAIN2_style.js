...
var styleCache_RAIN2={}
var style_RAIN2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (!styleCache_RAIN2[key]){
        ...
        styleCache_RAIN2[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_RAIN2[key]];
